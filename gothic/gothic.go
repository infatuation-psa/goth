...
See https://github.com/infatuation-psa/goth/blob/master/examples/main.go to see this in action.
*/
package gothic
...
See https://github.com/infatuation-psa/goth/examples/main.go to see this in action.
*/
